...
final class AppP {
    ...
    static private func setInitialData() {
        ...
        beer1["value"] = 2.59
        beer1["type"] = Int16(1)
        beerFacade.createBeer(data: beer1)
        ...
        beer2["value"] = 2.79
        beer2["type"] = Int16(1)
        beerFacade.createBeer(data: beer2)
        ...
        beer3["value"] = 2.10
        beer3["type"] = Int16(1)
        beerFacade.createBeer(data: beer3)
        ...
        beer4["value"] = 2.35
        beer4["type"] = Int16(1)
        beerFacade.createBeer(data: beer4)
        ...
        beer5["value"] = 10.99
        beer5["type"] = Int16(2)
        beerFacade.createBeer(data: beer5)
    }
